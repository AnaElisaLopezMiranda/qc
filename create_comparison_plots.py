...
# Find your CSV files
base_path = 'exp/dummy/reproduce/cube-triple-play-singletask-task2-v0/'
...
ax.plot(reproduction_data['step'], reproduction_data['success'],
...
if ablation_csv:
    ...
    ax.plot(ablation_data['step'], ablation_data['success'],
...
plt.fill_between(paper_steps, 
                ...
                paper_results['ci_highs'], 
                alpha=0.2)
plt.plot(reproduction_data['step'], reproduction_data['success'],
        label='My Reproduction', marker='s', linewidth=2, markersize=6)
